...
(() => {
  ...
  function t(t, i) {
    ...
    if (64 === p.charCodeAt(0)) {
      let e = r(p);
      (a && ((e.src = [a, m, t.length]), (e.dst = [a, m, t.length])),
        s.push(e));
    }
    if (h.length > 0 && d) {
      if ("rule" === d.kind)
  ...
  function P(e) {
    ...
    return (
      "compound" === e.kind && ((t += e.root), (t += "-"), (t += P(e.variant))),
